...
public class AuthActivity extends Activity {
    ...
    private void tryLoginWithToken() {
        ...
        if (token != null) {
            ...
            showProgress(true);
            mTokenSignInTask = new UserTokenSignInTask(this, token, serverAddress);
    ...
    public void attemptAuth() {
        ...
        if (!cancel) {
            ...
            showProgress(true);
            mSignInTask = new UserSignInTask(this, password, username, serverAddress);
    ...
    public class UserSignInTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserSignInTask(Context context, String password, String username, String serverAddress) {
            mContext = context;
            mPassword = password;
            mUsername = username;
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                ...
                Pair<Integer, String> response = new ServerConnector(mServerAddress).login(mUsername, mPassword);
                ...
                if (response.first/100 == 2) {
                    ...
                    Settings.saveServerAddress(mContext, mServerAddress);
                    Log.d(TAG, token);
                } else {
